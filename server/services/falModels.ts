...
export const FAL_MODEL_CATALOG: Record<FalCategory, FalModelConfig[]> = {
  ...
  "image-to-video": [
    {
      ...
      tier: "ultra",
      description: "Kling Pro 旗艦圖生影（5s/10s，首尾幀、motion_intensity、aspect_ratio、seed）",
      inputSchema: {
        imageUrl: true,
        prompt: true,
        duration: true,
    ...
    },
    {
      ...
      category: "image-to-video",
      tier: "premium",
      description: "Kling V2.1 標準版圖生影（5s/10s，首尾幀、motion_intensity、aspect_ratio、seed）",
      inputSchema: {
        imageUrl: true,
        prompt: true,
        duration: true,
    ...
    },
    {
      ...
      category: "image-to-video",
      tier: "standard",
      description: "WAN 2.1 開源圖生影（720p，可指定 seed/negative_prompt）",
      inputSchema: {
        imageUrl: true,
        prompt: true,
        numFrames: true,
    ...
    },
    {
      ...
      category: "image-to-video",
      tier: "premium",
      description: "MiniMax Hailuo 02 Pro 圖生影：超強首幀固定、6s/10s、768p/1080p、可開啟提詞優化",
      inputSchema: {
        imageUrl: true,
        prompt: true,
        duration: true,
    ...
    },
    {
      ...
      category: "image-to-video",
      tier: "standard",
      description: "LTX 開源圖生影（可自訂 num_frames / fps / guidance_scale / seed）",
      inputSchema: {
        imageUrl: true,
        prompt: true,
        numFrames: true,
    ...
    },
    {
      ...
      category: "image-to-video",
      tier: "premium",
      description: "Vidu Q1 角色一致性影片生成：最多 3 張參考圖（image_urls 陣列）；4s/8s；720p/1080p；16:9 / 9:16 / 1:1",
      inputSchema: {
        imageUrl: true,
        prompt: true,
        duration: true,
  ...
  "text-to-video": [
    ...
    },
    {
      ...
      category: "text-to-video",
      tier: "standard",
      description: "WAN T2V 高品質開源文生影（720p 開源、多語言、可指定 seed/aspect_ratio）",
      inputSchema: {
        prompt: true,
        numFrames: true,
        aspectRatio: true,
    ...
    },
    {
      ...
      category: "text-to-video",
      tier: "standard",
      description: "LTX 13B 蒸餾版開源文生影（可自訂 num_frames / fps / height / width / guidance_scale / seed）",
      inputSchema: {
        prompt: true,
        numFrames: true,
        fps: true,
    ...
    },
    {
      ...
      category: "text-to-video",
      tier: "premium",
      description: "MiniMax Hailuo 02 Pro 文生影（6s/10s，1080p/768p，支援提詞優化）",
      inputSchema: {
        prompt: true,
        duration: true,
        aspectRatio: true,
    ...
    },
    {
      ...
      category: "text-to-video",
      tier: "premium",
      description: "Google Veo 3（fal.ai 代理）：高擬真、唯一原生同步音訊；可指定 negative_prompt / seed / enhance_prompt",
      inputSchema: {
        prompt: true,
        aspectRatio: true,
        negativePrompt: true,
  ...
  "video-to-video": [
    {
      ...
      tier: "ultra",
      description: "Kling V2.1 影片風格轉換：保持原始動態、可指定 cfg_scale / negative_prompt / seed",
      inputSchema: {
        videoUrl: true,
        prompt: true,
        guidanceScale: true,
    ...
    },
    {
      ...
      category: "video-to-video",
      tier: "standard",
      description: "RIFE v4.6 高品質補幀：2x / 4x 幀率提升、可指定目標 fps（24-120）；計價依影片時長",
    ...
    },
    {
      ...
      category: "video-to-video",
      tier: "ultra",
      description: "Topaz 專業降噪 + 超解析：5 種內建模型（iris 人臉 / artemis 一般 / theia 細節 / gaia 高解析 / nyx 低光降噪）；可指定 output_scale 1-4；計價依影片時長",
      inputSchema: { videoUrl: true },
      outputSchema: { videoUrl: true },
      timeoutMs: 600_000,
    },
    // ── 進階控制：v2v 變體 ──
    {
      ...
      category: "video-to-video",
      tier: "standard",
      description: "從單目影片重建深度時序，用於 3D 視差或作為 ControlNet/AnimateDiff depth 條件；可指定 num_denoising_steps / guidance_scale / window_size / overlap / max_res；計價依影片時長",
