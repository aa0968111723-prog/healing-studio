    ...
    () => [
      {
        ...
        options: [
          ...
          { id: "/image-studio", label: "圖片工作室", meta: { bestFor: "圖像任務", tip: "先低成本試稿" } },
          { id: "/video-studio", label: "影片工作室", meta: { bestFor: "影片任務", tip: "先短時長驗證鏡頭語言" } },
          { id: "/pro-studio", label: "音樂配音工作室", meta: { bestFor: "音訊任務", tip: "先確定情緒/BPM 再生成" } },
