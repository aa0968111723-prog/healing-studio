      ...
      <div className="w-full max-w-3xl flex-1 flex flex-col pl-12 pr-4 sm:px-6 py-4 sm:py-8 gap-4 sm:gap-5 relative">
        ...
        <div className="flex flex-col items-center text-center gap-2.5">
          ...
          {isFirstTurn && (
            ...
            >
              <Collapsible open={showTaskTemplates} onOpenChange={setShowTaskTemplates}>
                <CollapsibleTrigger asChild>
                  <button
                    type="button"
                    className="w-full flex items-center justify-between gap-2 px-3 py-2 rounded-xl border border-border/60 bg-card/80 hover:bg-card transition-colors"
                    aria-label={showTaskTemplates ? "收起任務範本" : "展開任務範本"}
                  >
                    ...
                    <span className="flex items-center gap-1.5">
                      ...
                      <ChevronDown
                        className={`w-3.5 h-3.5 text-muted-foreground/70 transition-transform ${showTaskTemplates ? "rotate-180" : ""}`}
                      />
                    </span>
                  </button>
                </CollapsibleTrigger>
