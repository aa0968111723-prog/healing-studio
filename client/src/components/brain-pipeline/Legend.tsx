...
export function Legend({ legend }: Props) {
  return (
    <div className="absolute bottom-4 right-4 z-10 rounded-xl bg-card/90 backdrop-blur border border-border shadow-healing-md p-3 space-y-2 text-xs max-w-[260px]">
