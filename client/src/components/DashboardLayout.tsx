      ...
      <div className="flex items-center justify-center min-h-screen healing-wash-bg" style={{ background: "linear-gradient(135deg, #F5F3F0 0%, #EAC9C1 25%, #D4C5E2 55%, #C4DFCF 80%, #C8D5E0 100%)" }}>
        <div className="glass-card p-10 sm:p-12 max-w-md w-full mx-4 text-center">
          ...
          <Button
            ...
            size="lg"
            className="w-full mt-8 h-12 rounded-2xl shadow-md hover:shadow-lg hover:bg-opacity-80 transition-all duration-200 btn-healing"
          >
            Google 登入
          </Button>
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full mt-3 h-12 rounded-2xl border-dashed border-muted-foreground/30 hover:bg-muted/40 hover:shadow-md transition-all duration-200 btn-healing"
          >
            ✨ 訪客體驗（免登入）
          </Button>
        </div>
