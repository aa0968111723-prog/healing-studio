...
// Personality 與 SYSTEM_PROMPTS 抽到 shared/ 讓 site-prompt-catalog 也能 import。
// constants.ts 對外 API 不變，繼續 re-export。
import {
  DIRECTOR_PERSONALITY_SYSTEM_PROMPTS,
  type DirectorPersonality,
} from "@shared/director-personality-prompts";

export type Personality = DirectorPersonality;
...
export const PERSONALITY_SYSTEM_PROMPTS = DIRECTOR_PERSONALITY_SYSTEM_PROMPTS;
