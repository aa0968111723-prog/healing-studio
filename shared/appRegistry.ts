...
export const SIDEBAR_GROUPS: readonly SidebarGroupDefinition[] = [
  { id: "creation-hub", label: "創作中樞", icon: "Home", order: 10, description: "專案主控台、創作中樞與關鍵入口" },
  { id: "six-systems", label: "六大系統", icon: "Palette", order: 20, description: "導演、世界觀、分鏡、圖像、影片、聲音系統" },
  { id: "model-playground", label: "模型樂園", icon: "Sparkles", order: 30, description: "單模型工具、訓練與素材管理" },
