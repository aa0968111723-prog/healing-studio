...
export const APP_PAGE_REGISTRY: AppPageRegistryItem[] = [
  ...
  { id: "creative-projects", label: "創作專案", path: "/creative-projects", group: "project", description: "創作專案管理", aliases: ["projects", "我的專案", "創作專案"], showInSidebar: true, sidebarOrder: 60, sidebarGroup: "creation-hub", sidebarIcon: "FolderOpen", showInAgentHome: true, agentEntryPriority: 35, supportsPageAgent: false, quickActions: [{ id: "open-creative-projects", label: "打開創作專案", description: "查看創作專案列表", path: "/creative-projects" }], orbHints: ["打開創作專案"], supportedActions: [] },
  { id: "focus-flow", label: "專注流", path: "/focus-flow", group: "project", description: "專注節奏與番茄鐘", aliases: ["focus", "專注", "番茄鐘", "節奏"], showInSidebar: true, sidebarOrder: 80, sidebarGroup: "creation-hub", sidebarIcon: "Clock", showInAgentHome: true, agentEntryPriority: 33, supportsPageAgent: true, quickActions: [{ id: "open-focus-flow", label: "打開專注流", description: "進入專注流", path: "/focus-flow" }], orbHints: ["我要專注"], supportedActions: ["navigate", "setTab", "setParam"] },
