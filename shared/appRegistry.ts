...
export const APP_PAGE_REGISTRY: AppPageRegistryItem[] = [
  ...
  },
  {
    ...
    aliases: ["admin api", "用量", "api usage", "成本", "API 用量"],
    showInSidebar: true,
    sidebarOrder: 10,
    sidebarGroup: "management",
    sidebarIcon: "BarChart3",
...

  {
    ...
    group: "project",
    description: "專案主控台：把世界觀、腳本、分鏡、素材與生成紀錄綁在同一個專案下。",
  ...
  },
  {
    ...
    path: "/projects",
    group: "project",
    description: "Step 3 創作中樞骨架：列出所有 mock 創作專案，含進度、目前步驟、下一步建議。",
    aliases: ["projects", "我的專案", "專案列表", "創作專案清單"],
    showInSidebar: false,
    showInAgentHome: false,
    agentEntryPriority: 26,
    supportsPageAgent: false,
    quickActions: [
      {
        ...
        label: "查看專案清單",
        description: "前往創作專案列表",
        path: "/projects",
      },
    ],
    orbHints: ["帶我去專案清單", "看我的創作專案"],
    supportedActions: ["navigate"],
  },
  {
    id: "project-detail",
    ...
    path: "/projects/:id",
    group: "project",
    description: "Step 3 創作中樞骨架：單一專案 placeholder。顯示名稱、類型、狀態、目前步驟、下一步。",
    aliases: ["project detail", "專案詳情", "單一專案"],
    showInSidebar: false,
    showInAgentHome: false,
    agentEntryPriority: 27,
    supportsPageAgent: false,
    quickActions: [
      {
        id: "back-to-projects",
        label: "回到專案清單",
        description: "回到創作專案列表",
        path: "/projects",
      },
    ],
    orbHints: ["回到專案清單", "繼續這個專案"],
    supportedActions: ["navigate"],
  },
  {
    id: "process-viewer",
...
export type SidebarTreeBranch = {
  ...
  /**
   * Optional path navigated to when the flyout overflows the visible cap.
   * Mirrors SidebarGroupDefinition.seeAllPath so UI layers don't need to
   * look the group definition up again.
   */
  seeAllPath?: string;
};
